...
$Redirect_Url = "http://www.ecoagri.org/new/html/thankyou.htm" ;//your redirect URL where your customer will be redirected after authorisation from CCAvenue
...
<tr>
  <td height="26">Amount *</td><td height="26"><input type="text" name="txtAmount" maxlength="50" value="<?php echo $Amount; ?>"></td></tr>
<tr>
  <td height="26">Name *</td><td height="26"><input type="text" name="txtbilling_cust_name" maxlength="50" value="<?php echo $billing_cust_name; ?>"></td></tr>
<tr>
  <td height="26">Address</td><td height="26"><input type="text" name="txtbilling_cust_address" maxlength="50" value="<?php echo $billing_cust_address; ?>"></td></tr>
<tr><td height="26">City</td><td height="26"><input type="text" name="txtbilling_cust_city" maxlength="50" value="<?php echo $billing_city; ?>"></td></tr>
<tr><td height="26">State</td><td height="26"><input type="text" name="txtbilling_cust_state" maxlength="50" value="<?php echo $billing_cust_state; ?>"></td></tr>
<tr><td height="26">Country</td><td height="26"><input type="text" name="txtbilling_cust_country" maxlength="50" value="<?php echo $billing_cust_country; ?>"></td></tr>
<tr><td height="26">Zip Code</td><td height="26"><input type="text" name="txtbilling_zip_code" maxlength="50" value="<?php echo $billing_zip; ?>"></td></tr>
<tr>
  <td height="26">Telephone</td><td height="26"><input type="text" name="txtbilling_cust_tel" maxlength="50" value="<?php echo $billing_cust_tel; ?>"></td></tr>
<tr>
  <td height="26">Email *</td><td height="26"><input type="text" name="txtbilling_cust_email" maxlength="50" value="<?php echo $billing_cust_email; ?>"></td></tr>
<tr><td height="26"></td><td height="26"><INPUT TYPE="submit" value="Proceed To Payment" style="color:#FF0000; font-weight:bolder;"></td></tr>
</table>
</form>
    </div>
  </div>
