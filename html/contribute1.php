...
<tr><td height="40" colspan="3" align="left" valign="bottom" class="formtextstyle">
  <INPUT TYPE="submit" value="Proceed To Payment" style="color:#663366;background-color:#e7d1e7; height:25px; font-weight:bold; border-color:#cdb2cd;">
&nbsp;<strong>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>&nbsp; <a href="contribute.htm">
<input name="Button" type="button" value="Modify Details" style="color:#FFFFFF;background-color:#99cc99; height:25px; font-weight:bold; border-color:#999999;"></a></td></tr>
</table>
</form>
    </div>
  </div>
